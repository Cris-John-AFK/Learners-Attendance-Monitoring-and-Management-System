        ...
        return [
            {
                ...
                gradeLevel: 3,
                section: 'A',
                photo: photos[0]?.itemImageSrc || '', // Assign first photo
                attendance: [
                    {
                        subject: 'Math',
                        teacher: 'Mr. Smith',
            ...
            },
            {
                ...
                gradeLevel: 4,
                section: 'B',
                photo: photos[1]?.itemImageSrc || '', // Assign second photo
                attendance: []
            },
            {
                id: 1003,
                ...
                gradeLevel: 5,
                section: 'C',
                photo: photos[2]?.itemImageSrc || '', // Assign third photo
                attendance: []
            },
            {
                id: 1004,
                ...
                gradeLevel: 6,
                section: 'D',
                photo: photos[3]?.itemImageSrc || '', // Assign fourth photo
                attendance: []
            },
            {
                id: 1005,
                ...
                gradeLevel: 2,
                section: 'E',
                photo: photos[4]?.itemImageSrc || '', // Assign fifth photo
                attendance: []
            }
        ];
    },
