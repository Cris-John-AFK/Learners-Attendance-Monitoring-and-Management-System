                        ...
                        <div v-for="gradeStats in gradeStatistics" :key="gradeStats.grade" class="grade-stat-card">
                            ...
                            <div class="section-list">
                                ...
                                <div class="sections-chips">
                                    <span v-for="section in gradeStats.sections" :key="section.id" 
                                          class="section-chip" 
                            ...
                            <div class="grade-actions">
                                <Button label="View All Sections" 
                                        icon="pi pi-eye" 
                                        class="p-button-outlined p-button-sm" 
                                        @click="viewGradeSections(gradeStats.grade)" />
                                <Button label="Generate Report" 
                                        icon="pi pi-file-excel" 
                                        class="p-button-success p-button-outlined p-button-sm" 
                                        @click="generateGradeReport(gradeStats.grade)" />
                            </div>
                        </div>
                    </div>
                </div>
