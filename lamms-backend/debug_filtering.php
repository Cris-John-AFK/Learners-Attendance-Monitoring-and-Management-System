...
echo "=== TESTING THE EXACT FILTERING QUERY ===\n";
...
echo "Simple query returned " . $simpleStudents->count() . " students:\n";
foreach ($simpleStudents as $student) {
